...
public class MoreTools implements ModInitializer {
	...
	public static class Items {
		public static final Item WOODEN_HAMMER = new HammerToolItem(net.minecraft.item.Items.WOODEN_PICKAXE, ToolMaterial.WOOD);
		public static final Item STONE_HAMMER = new HammerToolItem(net.minecraft.item.Items.STONE_PICKAXE, ToolMaterial.STONE);
		public static final Item IRON_HAMMER = new HammerToolItem(net.minecraft.item.Items.IRON_PICKAXE, ToolMaterial.IRON);
		public static final Item GOLDEN_HAMMER = new HammerToolItem(net.minecraft.item.Items.GOLDEN_PICKAXE, ToolMaterial.GOLD);
		public static final Item DIAMOND_HAMMER = new HammerToolItem(net.minecraft.item.Items.DIAMOND_PICKAXE, ToolMaterial.DIAMOND);
		public static final Item NETHERITE_HAMMER = new HammerToolItem(net.minecraft.item.Items.NETHERITE_PICKAXE, ToolMaterial.NETHERITE);
		...
		public static final Item WOODEN_VEIN_HAMMER = new VeinHammerToolItem(net.minecraft.item.Items.WOODEN_PICKAXE, ToolMaterial.WOOD);
		public static final Item STONE_VEIN_HAMMER = new VeinHammerToolItem(net.minecraft.item.Items.STONE_PICKAXE, ToolMaterial.STONE, 4);
		public static final Item IRON_VEIN_HAMMER = new VeinHammerToolItem(net.minecraft.item.Items.IRON_PICKAXE, ToolMaterial.IRON, 5);
		public static final Item GOLDEN_VEIN_HAMMER = new VeinHammerToolItem(net.minecraft.item.Items.GOLDEN_PICKAXE, ToolMaterial.GOLD, 6);
		public static final Item DIAMOND_VEIN_HAMMER = new VeinHammerToolItem(net.minecraft.item.Items.DIAMOND_PICKAXE, ToolMaterial.DIAMOND, 6);
		public static final Item NETHERITE_VEIN_HAMMER = new VeinHammerToolItem(net.minecraft.item.Items.NETHERITE_PICKAXE, ToolMaterial.NETHERITE, 7);
